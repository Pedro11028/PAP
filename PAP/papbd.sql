...
--
-- Host: 127.0.0.1
-- Tempo de geração: 16-Abr-2023 às 17:06
...
CREATE TABLE `utilizadores` (
  ...
  `quizzCriados` int(6) DEFAULT NULL,
  `pontuação` int(11) DEFAULT NULL,
  `quizzesRealizados` int(6) DEFAULT NULL,
  `num_avaliações` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `imagem`
  ADD PRIMARY KEY (`Cod_img`,`Id_utilizador`),
  ADD KEY `Id_utilizador` (`Id_utilizador`);
...
--
ALTER TABLE `imagem`
  ADD CONSTRAINT `imagem_ibfk_1` FOREIGN KEY (`Id_utilizador`) REFERENCES `utilizadores` (`Id_utilizador`);
